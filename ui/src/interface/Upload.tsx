...
function Upload(props: UploadProps) {
    ...
    function handleDrop(e: any) {
        ...
        if (e.dataTransfer.length !== 0) {
            handleSubmission(e.dataTransfer.files[0]);
        }
    }
    useEffect(() => {
        ...
        <>
            <div className="instruction-page px-4 md:px-12">
                <div className="interface">
                    ...
                    <div className='pointer-none grid grid-cols-1 w-full h-screen justify-items-center justify-center' >
                        <div className='flex flex-row w-full items-center justify-center'>
                            <div className='w-full max-w-xl'>
                                {(!isUploading && !isProcessing) &&
                                    <div className='my-4 md:my-12 box-border border-dashed w-full text-center font-bold border-gray-400 rounded-md border-2 p-4 '>
                                        <UploadIcon />
                                ...
                                {(isUploading || isProcessing) &&
                                    <div className='text-center'>
                                        <p>{isProcessing ? "Processing..." : "Uploading..."}</p>
