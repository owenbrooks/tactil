...
# vmap = VectorMap(features={}, vertices=set(), edges=set(), labels=set())
# vmap = VectorMap(features={1: vec1, 2: vec2, 3: edge1, 4: vec3, 5: vec4, 6: edge2}, vertices={1, 2, 4, 5}, edges={3, 6}, labels=set())
